 ...
 * @access Public
 */
const getAllContent = asyncHandler(
 ...
 */
const updateContent = asyncHandler(
  async (req: Request<{ id: string }, {}, UpdateContentRequestBody>, res: Response) => {
    const { id } = req.params;
    const { title, description, category_id, media_url, thumbnail_url, tags, status } = req.body;
 ...
 */
const getRandomContent = asyncHandler(
  async (
    req: Request<{}, {}, {}, { category_id?: string; status?: ContentStatus }>,
    res: Response
  ) => {
...
const searchContent = asyncHandler(
  async (req: Request<{}, {}, {}, SearchQueryParams>, res: Response) => {
