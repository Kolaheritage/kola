 ...
 */
async function generateImageThumbnail(imagePath: string, filename: string): Promise<string> {
  try {
 ...
 */
async function generateVideoThumbnail(videoPath: string, filename: string): Promise<string | null> {
  try {
 ...
 */
async function deleteThumbnail(thumbnailFilename: string): Promise<boolean> {
  try {
